...
<table width="125%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td  class="style43 style51">&nbsp;</td>
            <td colspan="3"  class="style58">Elaborado Por: <input name="txtf_elab" id="txtf_elab" type="text" class="form-control neg" onkeypress="return handleEnter(this, event);" size="40" value="GNK Log&iacute;stica S.A. de C.V." /></td>
            </tr>
       <form  method="post" name="form_a" id="form_account_a" class="form-horizontal" action="/CensosVer/campos?ban=1" >
		...
		//		int contCam=79;
          ...
          <tr>
            ...
            <td class="style33"><label><textarea name="<%=nombreC=nomCam+(contCam+=1)%>" cols="40" class="form-control" id="<%=nombreC%>" onkeypress="return handleEnter(this, event);"  ></textarea>
            <%out.print(nombreC);%></label>   
            </td>
          ...
          <tr>
            ...
            <td class="style33"><strong>
              ...
              <input name="<%=nombreC=nomCam+(contCam+=1)%>" type="text" id="<%=nombreC%>" size="7" maxlength="7" />
               <%out.print(nombreC);%></label> 
          ...
          <tr>
            ...
            <td> <label><textarea name="<%=nombreC=nomCam+(contCam+=1)%>2" cols="40" class="form-control" id="<%=nombreC%>" onkeypress="return handleEnter(this, event);" ></textarea>
              <%out.print(nombreC);%></label></td>
            </tr>
             <tr>
            <td class="style58"><div align="center">B.7</div></td>
            ...
            <td> <label><textarea name="<%=nombreC=nomCam+(contCam+=1)%>4" cols="40" class="form-control" id="<%=nombreC%>" onkeypress="return handleEnter(this, event);" ></textarea>
              <%out.print(nombreC);%></label></td>
            </tr>
             <tr>
            ...
            <td> <label><textarea name="<%=nombreC=nomCam+(contCam+=1)%>6" cols="40" class="form-control" id="<%=nombreC%>" onkeypress="return handleEnter(this, event);" ></textarea>
              <%out.print(nombreC);%></label></td>
            </tr>
 <tr>
          ...
          <tr>
            ...
            <td><span class="style58">De:</span>
                  <input name="<%=nombreC=nomCam+(contCam+=1)%>" type="text" id="<%=nombreC%>" size="5" maxlength="5" onkeypress="return handleEnter(this, event);" />
                    <%out.print(nombreC);%></label> 
          ...
          <tr>
            ...
            <td class="style58"><label><textarea name="<%=nombreC=nomCam+(contCam+=1)%>" cols="40" class="form-control" id="<%=nombreC%>" onkeypress="return handleEnter(this, event);" ></textarea>
             <%out.print(nombreC);%></label> 
            </td>
           <td class="style58">&nbsp;</td>
 ...
 <tr>
           ...
           <td class="style58">&nbsp;</td>
            ...
            <td class="style58">Equipo de Cómputo:</td>
            <td>
                <p>&nbsp;</p>
              <div align="center" class="style58">
                <div align="center">
                  <p>
                    <input type="text" name="<%=nombreC=nomCam+(contCam+=1)%>" id="<%=nombreC%>" size="3" maxlength="3" />
...
<div align="center" class="style58">
            ...
            <td class="style58"></span><span class="style47">
  ...
  %>
          ...
          <tr>
            <td colspan="7" class="style58"><table width="637" border="0" align="center" cellpadding="2">
              <tr>
                <td width="118"><strong class="style58"></strong></td>
          ...
          <tr>
            <td colspan="7" class="style47"><div align="center"><strong><span class="style41"><strong>
             ...
             <label>  <textarea name="<%=nombreC=nomCam+(contCam+=1)%>8" cols="140" rows="10" class="form-control style58" id="<%=nombreC%>" onkeypress="return handleEnter(this, event);" ></textarea>
               <%out.print(nombreC);%></label> </strong></span></strong></span></strong></div></td>
            </tr>
